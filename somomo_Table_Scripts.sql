...
INSERT INTO MEMBER 
VALUES ('admin', '$2a$10$0ZZFnmV2fxN1JNAg1BSsx.kcLqQXMK6apchthmGiCETVsYG0DdAya', '관리자', '01000000000', 'admin@email.com', 0, 'F', 'resources/img/member/profile_img/profile_img.png', DEFAULT, DEFAULT, DEFAULT);

INSERT INTO MEMBER 
VALUES ('user01', '$2a$10$CKY0j.HOti0nase1N3zWgu1TWQyV16N.v1mballOcVVWGy5aeWjBC', '유저1', '01011111111', 'josephchome888@gmail.com', 20, 'M', 'resources/img/member/profile_img/profile_img.png', DEFAULT, DEFAULT, DEFAULT);
--------------------------------------------------
--------------    REGION_CATEGORY	--------------
--------------------------------------------------
...
CREATE TABLE GROUP_ROOM(
    ...
    APPLY_QUESTION VARCHAR2(500),
    INVITE_CODE VARCHAR2(5),
...
COMMENT ON COLUMN GROUP_ROOM.APPLY_QUESTION IS '가입질문';
COMMENT ON COLUMN GROUP_ROOM.INVITE_CODE IS '초대코드';
...
CREATE TABLE GROUP_JOIN_APPLY(
    ...
    STATUS VARCHAR2(1) DEFAULT 'Y' CHECK(STATUS IN('Y', 'N', 'J')),
    FOREIGN KEY(GROUP_NO) REFERENCES GROUP_ROOM ON DELETE CASCADE,
    FOREIGN KEY(USER_ID) REFERENCES MEMBER ON DELETE CASCADE
);
...
COMMENT ON COLUMN CHAT_ROOM.ROOM_THUMBNAIL IS '채팅방썸네일';
...
COMMENT ON COLUMN CHAT_MEMBER.INSERT_DATE IS '채팅방참가일';
COMMENT ON COLUMN CHAT_MEMBER.CHAT_COUNT IS '쌓인 채팅 수';
...
COMMENT ON COLUMN CHAT.CHAT_TIME IS '작성시간';
