...
DROP SEQUENCE SEQ_GCANO; -- GROUP_CALENDAR
...
INSERT INTO MEMBER 
VALUES ('admin', '1234', '관리자', '01000000000', 'admin@email.com', 0, 'F', NULL, DEFAULT, DEFAULT, DEFAULT);

INSERT INTO MEMBER 
VALUES ('user01', 'pass01', '유저1', '01011111111', 'user01@email.com', 20, 'M', NULL, DEFAULT, DEFAULT, DEFAULT);
--------------------------------------------------
--------------    REGION_CATEGORY	--------------
--------------------------------------------------
-- VO명 수정해야함
...
CREATE TABLE FEED_BOARD(
    ...
    BOARD_TYPE VARCHAR2(1) CHECK(BOARD_TYPE IN('A', 'B')), -- A : 일반, B : 모임
...
CREATE SEQUENCE SEQ_GCANO NOCACHE;

COMMENT ON COLUMN GROUP_CALENDAR.CALENDAR_NO IS '캘린더번호';
COMMENT ON COLUMN GROUP_CALENDAR.GROUP_NO IS '그룹방번호';
COMMENT ON COLUMN GROUP_CALENDAR.TITLE IS '캘린더제목';
COMMENT ON COLUMN GROUP_CALENDAR.MEMO IS '캘린더메모';
COMMENT ON COLUMN GROUP_CALENDAR.START_DATE IS '시작날짜';
COMMENT ON COLUMN GROUP_CALENDAR.END_DATE IS '종료날짜';
